...
class Validator implements ValidatorContract
{
    ...
    protected function validateAttribute($attribute, $rule)
    {
        ...
        if ($rule instanceof RuleContract || $rule instanceof CustomRule) {
            return $validatable
    ...
    {
        return $rule instanceof ImplicitRule || $rule instanceof \Laravel\Foundation\Validation\ImplicitRule ||
    ...
    protected function validateUsingCustomRule($attribute, $value, $rule)
    {
        ...
        if (!$rule->passes($attribute, $value, $this->data, $this)) {
