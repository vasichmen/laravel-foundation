...
class ValidationRuleParser
{
    ...
    {
        if ($rule instanceof CustomRule || $rule instanceof NestedRules || $rule instanceof Rule) {
            return [$rule, []];
        }
    ...
    {
        $all = collect($rules)->mapWithKeys(function ($attributeRules, $attribute) use ($data) {
