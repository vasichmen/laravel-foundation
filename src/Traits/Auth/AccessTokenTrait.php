...
namespace Laravel\Foundation\Traits\Auth;
...
trait AccessTokenTrait
{
    ...
    private function convertToJWT()
    {
        ...
        foreach ($this->getCustomClaims() as $name => $customClaim) {
            $builder->withClaim($name, $customClaim);
        }

        return $builder->getToken($this->jwtConfiguration->signer(), $this->jwtConfiguration->signingKey());
    }

    protected function getCustomClaims(): array
    {
        return [];
    }
