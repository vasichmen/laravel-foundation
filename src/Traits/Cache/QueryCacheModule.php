...
trait QueryCacheModule
{
    ...
    /**
     * Set if specify cache key required
     *
     * @var string
     */
    ...
    public function generatePlainCacheKey(string $method = 'get', string $id = null, string $appends = null): string
    {
        ...
        return $name . $method . $id . $this->toSql() . serialize($this->getBindings()) . serialize(array_keys($this->eagerLoad)) . $appends;
    }
    ...
    public function getCache()
    {
        ...
        $tags = $this->getCacheTags() ?: ($this->getCacheBaseTags() ?: []);
